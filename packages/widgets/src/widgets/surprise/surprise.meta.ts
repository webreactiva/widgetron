...
export const surpriseMeta: WidgetMeta = {
  ...
  whenToUse:
    "Use for a delight moment mid- or end-of-guide — a bonus video, a quote, or a copy-ready prompt the reader unwraps on demand. The teaser builds anticipation; the payload fades in on click and stays open. Reach for it when the reveal itself is part of the reward; prefer CalloutBox when the point should always be visible, and put the surprise content (any widget) in `content`.",
  schema: z.object({
